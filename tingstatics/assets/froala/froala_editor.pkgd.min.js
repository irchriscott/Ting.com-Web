...
! function (n) {
    ...
    s.DEFAULTS = {
        ...
        if ("string" == typeof i) {
            ...
            return this.each(function () {
                var e, t, n = Ee(this).data("froala.editor");
                if (!n) return console.warn("Editor should be initialized before calling the " + i + " method.");
                if (0 < i.indexOf(".") && n[i.split(".")[0]] ? (n[i.split(".")[0]] && (e = n[i.split(".")[0]]), t = i.split(".")[1]) : (e = n, t = i.split(".")[0]), !e[t]) return Ee.error("Method " + i + " does not exist in Froala Editor.");
                var r = e[t].apply(n, a.slice(1));
    ...
    if (Ee.FE.LinkRegExCommon = "[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}", Ee.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", Ee.FE.LinkRegExTLD = "((" + Ee.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", Ee.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + Ee.FE.LinkRegExCommon + ")", Ee.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + Ee.FE.LinkRegExCommon + ")", Ee.FE.LinkRegExWWW = "(www\\." + Ee.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", Ee.FE.LinkRegEx = "(" + Ee.FE.LinkRegExTLD + "|" + Ee.FE.LinkRegExHTTP + "|" + Ee.FE.LinkRegExWWW + "|" + Ee.FE.LinkRegExAuth + ")" + Ee.FE.LinkRegExEnd, Ee.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], Ee.FE.MAIL_REGEX = /.+@.+\..+/i, Ee.FE.MODULES.helpers = function (a) {
            ...
            I: "EM",
            STRIKE: "S"
        }, Ee.FE.MODULES.clean = function (c) {
            var f, p, u, h;
                                ...
                                for (var p = 0, u = c.length; p < u; p++)
                                    if (c[p].selectorText && 0 < c[p].style.cssText.length) {
                                        ...
                                        for (i = 0; i < h.length; i++) {
                                            ...
                                            for (var m = 1e3 * f + w(c[p].selectorText), v = c[p].style.cssText.split(";"), E = 0; E < v.length; E++) {
        ...
        }), Ee.FE.MODULES.placeholder = function (c) {
            function e() {
            ...
            return Ee.extend(s, {
                ...
                _init: function () {
                    o.events.on("keydown", function (e) {
                        ...
                        var t = o.selection.element();
                        if (t && "HR" == t.tagName)
                            if (e.which == Ee.FE.KEYCODE.ARROW_LEFT || e.which == Ee.FE.KEYCODE.ARROW_UP) {
            ...
            return {
                ...
                get: function (e) {
                    ...
                    if (!r)
                        for (var t in r = {}, Ee.FE.SHORTCUTS_MAP) Ee.FE.SHORTCUTS_MAP.hasOwnProperty(t) && 0 <= s.opts.shortcutsEnabled.indexOf(Ee.FE.SHORTCUTS_MAP[t].cmd) && (r[Ee.FE.SHORTCUTS_MAP[t].cmd + "." + (Ee.FE.SHORTCUTS_MAP[t].val || "")] = {
            ...
            function x(r, e) {
                ...
                for (var _, L, x = {
                    ...
                    } else "#" === c && "{" === g() ? (x.preserveSingleSpace(), N.push(m("}"))) : "{" === c ? "}" === g(!0) ? (v(), h(), x.singleSpace(), N.push("{}"), x.newLine(), l && 0 === R && x.newLine(!0)) : (R++, C += S, x["{"](c), I ? (I = !1, w = y < R) : w = y <= R) : "}" === c ? (R--, C = C.slice(0, -i), x["}"](c), O = w = !1, y && y--, l && 0 === R && x.newLine(!0)) : ":" === c ? (v(), !w && !I || T("&") || A() ? ":" === g() ? (h(), N.push("::")) : N.push(":") : (O = !0, N.push(":"), x.singleSpace())) : '"' === c || "'" === c ? (x.preserveSingleSpace(), N.push(m(c))) : ";" === c ? (O = !1, N.push(c), x.newLine()) : "(" === c ? T("url") ? (N.push(c), v(), h() && (")" !== c && '"' !== c && "'" !== c ? N.push(m(")")) : p--)) : (u++, x.preserveSingleSpace(), N.push(c), v()) : ")" === c ? (N.push(c), u--) : "," === c ? (N.push(c), v(), o && !O && u < 1 ? x.newLine() : x.singleSpace()) : ("]" === c || ("[" === c ? x.preserveSingleSpace() : "=" === c ? (v(), c = "=") : x.preserveSingleSpace()), N.push(c))
                }
                var K = "";
                ...
                return new function (r, e) {
                    ...
                    u = {
                        ...
                        TK_START_BLOCK: function () {
                            ...
                            "expand" === h.brace_style || "none" === h.brace_style && s.wanted_newline ? "TK_OPERATOR" !== l && (n || "TK_EQUALS" === l || "TK_RESERVED" === l && O(f.last_text) && "else" !== f.last_text) ? o.space_before_token = !0 : A(!1, !0) : "TK_OPERATOR" !== l && "TK_START_EXPR" !== l ? "TK_START_BLOCK" === l ? A() : o.space_before_token = !0 : _(p.mode) && "," === f.last_text && ("}" === d ? o.space_before_token = !0 : A()), S(), R()
                        },
                        ...
                        TK_SEMICOLON: function () {
                            for (w() && (o.space_before_token = !1); f.mode === k.Statement && !f.if_block && !f.do_block;) x();
                            S()
                        },
                        TK_STRING: function () {
                            w() ? o.space_before_token = !0 : "TK_RESERVED" === l || "TK_WORD" === l ? o.space_before_token = !0 : "TK_COMMA" === l || "TK_START_EXPR" === l || "TK_EQUALS" === l || "TK_OPERATOR" === l ? N() || T() : A(), S()
                        },
                        TK_EQUALS: function () {
                            w(), f.declaration_statement && (f.declaration_assignment = !0), o.space_before_token = !0, S(), o.space_before_token = !0
                        },
                        TK_OPERATOR: function () {
                            if (w(), "TK_RESERVED" === l && O(f.last_text)) return o.space_before_token = !0, void S();
                            if ("*" !== s.text || "TK_DOT" !== l) {
                        ...
                        TK_DOT: function () {
                            w(), "TK_RESERVED" === l && O(f.last_text) ? o.space_before_token = !0 : T(")" === f.last_text && h.break_chained_methods), S()
                        },
                        TK_UNKNOWN: function () {
                    ...
                    function D() {
                        ...
                        if (w() || !s.wanted_newline || L(f.mode) || "TK_OPERATOR" === l && "--" !== f.last_text && "++" !== f.last_text || "TK_EQUALS" === l || !h.preserve_newlines && "TK_RESERVED" === l && G(f.last_text, ["var", "let", "const", "set", "get"]) || A(), f.do_block && !f.do_while) {
                                ...
                                function o() {
                                    ...
                                    if (n.length && (D = n.join("")), x.test(r)) {
                                        var i = !0,
                                            a = !0,
                                            o = x;
                                        for ("0" === r && M < $ && /[Xxo]/.test(y.charAt(M)) ? (a = i = !1, r += y.charAt(M), M += 1, o = /[o]/.test(y.charAt(M)) ? N : w) : (r = "", M -= 1); M < $ && o.test(y.charAt(M));) r += y.charAt(M), M += 1, i && M < $ && "." === y.charAt(M) && (r += y.charAt(M), M += 1, i = !1), a && M < $ && /[Ee]/.test(y.charAt(M)) && (r += y.charAt(M), (M += 1) < $ && /[+-]/.test(y.charAt(M)) && (r += y.charAt(M), M += 1), i = a = !1);
                                        return [r, "TK_WORD"]
                                    }
            ...
            fontFamily: {
                ...
                "Poppins,Geneva,sans-serif": "Poppins"
            },
            ...
            function N(e) {
                ...
                void 0 === e && O(c.language.translate("Uploading"), 0)
            }
            ...
            function k(o, e, s, l, d) {
                c.edit.off(), O(c.language.translate("Loading image")), e && (o = c.helpers.sanitizeURL(o));
                var t = new Image;
                t.onload = function () {
                    var e, t;
                    if (l) {
            ...
            function F(e) {
                O(c.language.translate("Loading image"));
                var t = this.status,
                    n = this.response,
                    r = this.responseXML,
                    i = this.responseText;
            ...
            function $(e) {
                if (e.lengthComputable) {
                    var t = e.loaded / e.total * 100 | 0;
                    O(c.language.translate("Uploading"), t)
                }
            }
            ...
            function Y() {
                ...
                e || (e = G()), w(), c.popups.refresh("image.alt"), c.popups.setContainer("image.alt", c.$sc);
                var t = me();
            ...
            function X() {
                var e = c.popups.get("image.size");
                e || (e = q()), w(), c.popups.refresh("image.size"), c.popups.setContainer("image.size", c.$sc);
                var t = me();
                ve() && (t = t.find(".fr-img-wrap"));
                var n = t.offset().left + t.outerWidth() / 2,
                    r = t.offset().top + t.outerHeight();
            ...
            function ee(e) {
                ...
                K([new Blob([new Uint8Array(n)], {
                    type: Ee(e).attr("src").split(",")[0].replace(/data\:/g, "").replace(/;base64/g, "")
                })], f)
            }
            ...
            function ue() {
                ...
                e || (e = W()), c.popups.isVisible("image.insert") || (w(), c.popups.refresh("image.insert"), c.popups.setContainer("image.insert", c.$sc));
                var t = me();
                ve() && (t = t.find(".fr-img-wrap"));
                var n = t.offset().left + t.outerWidth() / 2,
                    r = t.offset().top + t.outerHeight();
            ...
            return {
                ...
                showInsertPopup: function () {
                    ...
                    if (t || (t = W()), w(), !t.hasClass("fr-active"))
                ...
                insertByURL: function () {
                    var e = c.popups.get("image.insert").find(".fr-image-by-url-layer input");
                    if (0 < e.val().length) {
                        N(), O(c.language.translate("Loading image"));
                        var t = e.val();
            ...
            function O(e) {
                ...
                n.image.insert(t.data("url"), !1, w(t), r)
            }
            ...
            function I(e) {
                ...
                confirm(t) && (s.opts.imageManagerDeleteURL ? !1 !== s.events.trigger("imageManager.beforeDeleteImage", [n]) && (n.parent().addClass("fr-image-deleting"), Ee.ajax({
                    ...
                    data: Ee.extend(Ee.extend({
                        src: n.attr("src")
                    }, w(n)), s.opts.imageManagerDeleteParams),
    ...
    Ee.FE.DEFAULTS.imageInsertButtons.push("imageManager"), Ee.FE.RegisterCommand("imageManager", {
        ...
        NAME: "magic"
    }), Ee.FE.PLUGINS.print = function (i) {
        return {
            run: function () {
                var e = i.$el.html(),
                    t = null;
        ...
        function e(e) {
            ...
            if (0 < Q().length && !t && D(), !T.edit.isDisabled() || T.popups.isVisible("table.edit"))
                ...
                e.shiftKey && 0 < T.$el.find(n + ".fr-selected-cell").length ? Ee(T.$el.find(n + ".fr-selected-cell").closest("table")).is(Ee(t).closest("table")) ? O(r, t) : x() : ((T.keys.ctrlKey(e) || e.shiftKey) && (1 < Q().length || 0 === Ee(t).find(T.selection.element()).length && !Ee(t).is(T.selection.element())) && x(), O(r = t, r))
            }
        }
            ...
            T.opts.tableResizer && (!T.popups.areVisible() || T.popups.areVisible() && T.popups.isVisible("table.edit")) && K(e, t), !T.opts.tableInsertHelper || T.popups.areVisible() || T.$tb.hasClass("fr-inline") && T.$tb.is(":visible") || function (e, t) {
                if (0 === Q().length) {
                    ...
                    if (t && ("HTML" == t.tagName || "BODY" == t.tagName || T.node.isElement(t)))
                        for (n = 1; n <= T.opts.tableInsertHelperOffset; n++) {
        ...
        function I(e, t, n, r) {
            return e.pageX = t, e.pageY = t, N.call(this, e), e.pageX = e.pageX + n * Math.floor(Math.pow(1.1, r)), e.pageY = e.pageY + n * Math.floor(Math.pow(1.1, r)), w.call(this, e), O.call(this, e), ++r
        }
        ...
        function k() {
            p || function () {
                ...
                if (f.shared.$video_resizer ? (p = f.shared.$video_resizer, s = f.shared.$vid_overlay, f.events.on("destroy", function () {
                    ...
                    e = p.get(0).ownerDocument, f.events.$on(p, f._mousedown, ".fr-handler", N), f.events.$on(Ee(e), f._mousemove, w), f.events.$on(Ee(e.defaultView || e.parentWindow), f._mouseup, O), f.events.$on(s, "mouseleave", O);
                    var r = 1,
                        i = null,
                        a = 0;
        ...
        function V(e, t, n) {
            !f.opts.htmlUntouched && f.opts.useClasses ? (e.removeClass("fr-fvl fr-fvr fr-dvb fr-dvi"), e.addClass("fr-fv" + n[0] + " fr-dv" + t[0])) : "inline" == t ? (e.css({
                display: "inline-block"
            }), "center" == n ? e.css({
                "float": "none"
            }) : "left" == n ? e.css({
        ...
        return i[1] = "Video cannot be loaded from the passed link.", i[l] = "No link in upload response.", i[d] = "Error during file upload.", i[h] = "Parsing response failed.", i[g] = "File is too large.", i[m] = "Video file type is invalid.", i[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", f.shared.vid_exit_flag = !1, {
            ...
            insertByURL: function (e) {
                ...
                if (/^http/.test(e) || (e = "https://" + e), f.helpers.isURL(e))
                    for (var n = 0; n < Ee.FE.VIDEO_PROVIDERS.length; n++) {
